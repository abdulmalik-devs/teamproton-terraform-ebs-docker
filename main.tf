...
module "EBS" {
  ...
  frontend_ebs_ec2_role_launch_config   = module.IAM_ROLE.iam_role_id
  frontend_ebs_ec2_role_environ_default = module.IAM_ROLE.iam_role_id
  ...
  admin_ebs_ec2_role_launch_config      = module.IAM_ROLE.iam_role_id
  admin_ebs_ec2_role_environ_default    = module.IAM_ROLE.iam_role_id
  ...
  backend_ebs_ec2_role_launch_config    = module.IAM_ROLE.iam_role_id
  backend_ebs_ec2_role_environ_default  = module.IAM_ROLE.iam_role_id
